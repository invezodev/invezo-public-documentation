---
title: "GitHub Active Issues"
description:
  "Issues are a bug tracking system built into Github. They provide a way for
  people to report problems, receive feedback, and collaborate together on code
  projects. Active issues shows issues that are not closed."
api: "GET https://api.invezo.com/v1/developer/github/issues/active"
---
