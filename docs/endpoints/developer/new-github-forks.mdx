---
title: "New GitHub Forks"
description:
  "Users typically fork a Github repository to copy it and make modifications to
  it. Forking a Github repository allows users to edit code without affecting
  the original project. This typically shows developer interest in contributing
  to crypto projects."
api: "GET https://api.invezo.com/v1/developer/github/new_forks"
---
