---
title: "Retweet Volume"
description:
  "Tweet volume is a measure of the number of individual tweets mentioning an
  asset's name or symbol. Retweet volume excludes all original tweets from the
  count, measuring only accounts that retweet something that mentions an asset."
api: "GET https://api.invezo.com/v1/social/twitter/volume_retweets"
---
