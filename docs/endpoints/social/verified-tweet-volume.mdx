---
title: "Verified Tweet Volume"
description:
  "Tweet volume is a measure of the number of individual tweets mentioning an
  asset's name or symbol. Verified tweet volume measures how many verified
  accounts mentioned an asset in a tweet or retweet."
api: "GET https://api.invezo.com/v1/social/twitter/volume_verified"
---
