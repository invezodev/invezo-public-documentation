...
title: "Funding Rate"
description:
  "Funding rates are periodic payments either to traders that are long or short
  based on the difference between perpetual contract markets and spot prices."
api: "GET https://api.invezo.com/v1/derivatives/funding_rate"
---
